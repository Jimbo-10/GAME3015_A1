...
void Game::LoadTextures()
{
	...
	auto HillTex = std::make_unique<Texture>();
	HillTex->Name = "HillTex";
	HillTex->Filename = L"../../Textures/ice.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
		mCommandList.Get(), HillTex->Filename.c_str(),
		HillTex->Resource, HillTex->UploadHeap));
...
void Game::BuildMaterials()
{
	...
	mMaterials["stone"] = std::move(Raptor);
	...
	mMaterials["ice"] = std::move(Desert);
