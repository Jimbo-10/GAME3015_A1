...
public:
    ...
    CameraApp(const CameraApp& rhs) = delete;
...
void CameraApp::BuildDescriptorHeaps()
{
	...
	auto skullTex = mTextures["skullDiffuseMap"]->Resource;
...
void CameraApp::BuildMaterials()
{
	...
	auto skull0 = std::make_unique<Material>();
	skull0->Name = "skull0";
	skull0->MatCBIndex = 3;
	skull0->DiffuseSrvHeapIndex = 3;
	skull0->DiffuseAlbedo = XMFLOAT4(0.8f, 0.8f, 0.8f, 1.0f);
	skull0->FresnelR0 = XMFLOAT3(0.2f, 0.2f, 0.2f);
	skull0->Roughness = 0.2f;
	
	mMaterials["bricks0"] = std::move(bricks0);
	mMaterials["stone0"] = std::move(stone0);
	mMaterials["tile0"] = std::move(tile0);
	mMaterials["skull0"] = std::move(skull0);
}
...
void CameraApp::BuildRenderItems()
{
	...
	skullRitem->Mat = mMaterials["skull0"].get();
